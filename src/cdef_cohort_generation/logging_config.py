...
class RichLogger:
    def __init__(self, name: str, log_file: Path):
        ...
        logging.basicConfig(
            ...
            handlers=[
                ...
                RichHandler(
                    console=Console(file=open(log_file, "a", encoding="utf-8")),
                    show_time=True,
                    show_path=True,
                ),
            ],
    ...
    def log(self, message: str, level: LogLevel = "info", **kwargs: Any):
...
# You can keep this function if you want to maintain the same interface
